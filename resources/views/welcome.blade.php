...
<div class="wrapper ">
    <div class="text-right px-3 pt-3">
        <a href="{{ url('/login') }}" class="btn access-button main-btn logout font-blue-light-14">Log In</a>
        <a href="{{ url('/register') }}" class="btn access-button main-btn logout font-blue-light-14">Register</a>
    </div>
